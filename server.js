...
<body>
  ...
  <script type="text/babel">
    ...
    const QUIZ_DATA = [
      ...
      { cat: "구약", q: "다윗이 물맷돌로 쓰러뜨린 블레셋 장수의 이름은?", opts: ["골리앗", "삼손", "김목민", "아각"], a: 0, ex: "다윗은 물맷돌 하나로 거인 골리앗을 쓰러뜨렸습니다." },
      ...
      { cat: "넌센스", q: "김목민의 생일은??", opts: ["5월5일", "7월3일", "6월4일", "12월25일"], a: 2, ex: "구레네 사람 시몬이 예수님의 십자가를 대신 졌습니다." },
      ...
      { cat: "넌센스", q: "김목민의 키는??", opts: ["163cm", "171cm", "168cm", "183cm"], a: 2, ex: "약 120명의 성도가 기도하다가 성령 충만을 받았습니다." },
      { cat: "구약", q: "이스라엘의 초대 왕은 누구인가요?", opts: ["사무엘", "사울", "다윗", "솔로몬"], a: 1, ex: "사울이 이스라엘의 첫 번째 왕이 되었습니다." },
      { cat: "넌센스", q: "김목민의 고향은??", opts: ["해남", "완도", "전복", "광주"], a: 1, ex: "예수님은 베다니의 나사로를 무덤에서 살리셨습니다." }
    ];
